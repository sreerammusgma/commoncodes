...
class folderVideo(object):
	...
	def __init__(self, destination, folder_path, fps=20, video_shape=(480,640),starting_index=1, ending_index=100, prefix="", suffix=".jpg",skip_frames=0):
		...
		if type(video_shape) is not tuple:
			TypeError("Input Error: video_shape is not a tuple")
...
class TestStringMethods(unittest.TestCase):
	...
	def test_4(self):
		try:
			result = False
			ob1=folderVideo(destination="/home/ram/",folder_path="/home/srrma")
		except TypeError:
			result = True
	...
	def test_6(self):
		try:
			result = False
			ob1=folderVideo(destination,folder_path,fps =20, starting_index='t')
		except TypeError:
			result = True
			self.assertTrue(result)
	...
	def test_7(self):
		try:
			result = False
			ob1=folderVideo(destination,folder_path,fps =20, starting_index=1, ending_index = '7')
		except TypeError:
			result = True
			self.assertTrue(result)
	...
	def test_8(self):
		try:
			result = False
			ob1=folderVideo(destination,folder_path,fps =20, starting_index=1, ending_index = 200, prefix=20)
		except TypeError:
			result = True
			self.assertTrue(result)
	...
	def test_9(self):
		try:
			result = False
			ob1=folderVideo(destination,folder_path,fps =20, starting_index=1, ending_index = 200, prefix='',suffix=(3,5))
		except TypeError:
			result = True
			self.assertTrue(result)
	...
	def test_10(self):
		try:
			result = False
			ob1=folderVideo(destination,folder_path,fps =20, starting_index=1, ending_index = 200, prefix='',suffix='.jpg', skip_frames='.jpg')
		except TypeError:
			result = True
			self.assertTrue(result)
